    ...
    <div class="flex-row-ver-center">
      ...
      <div class="flex-fixed-item">
        ...
        <el-button class="filter-item" style="margin-left: 10px;" type="primary"
                   v-hasPermi="['uniapp:article:edit']"
...
<script>
import { getArticlePagedList, deleteArticle, bindArticleToColumns, setArticleOnTop, cancelArticleOnTop } from '@/api/monitor/articles'
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      ...
      this.$router.push('/uniapp/article-edit')
    },
    // 修改按钮点击方法
    handleUpdate(row) {
